...
import com.wangxingxing.videocollections.ui.common.view.GridListItemDecoration
        ...
        when (holder) {
            ...
            is AutoPlayVideoAdViewHolder -> {
                item.data.detail?.run {
                    ...
                    RecommendAdapter.startAutoPlay(fragment.activity, holder.videoPlayer, position, url, imageUrl, RecommendAdapter.TAG, object : GSYSampleCallBack() {
